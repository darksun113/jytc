<template>
	<view>
		...
		<!-- 预付支付按钮模块 -->
		<prepayModule v-if="(goodsData.prepayStatus==1 && goodsData.balanceEndTime > curTime && goodsData.goodsStatus == 5) || (goodsData.goodsType == 3 && ![3,4,5].includes(goodsData.goodsStatus))" 
